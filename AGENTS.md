...
- real SSH/Kerberos/network flows
...
- Vogsphere is not a correction source yet.
...
cd /home/xapet/Downloads/exam/piscine-forge-rebuilt
...
- Tests reached 201 passed before the Exam phase.
- Local Vogsphere exists but is not used by correction.
- Project requirements/check exists for existing Piscine projects.
- Some Exam terminal work may be partially modified; inspect tests before continuing.
